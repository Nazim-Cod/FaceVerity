...
Compatible TensorFlow 2.13 / Python 3.8+

Lancer : streamlit run gui/app.py
"""
...
def main():
    ...
    <div class="hero">
        <h1>🔍 FaceVerify</h1>
        <p>Vérification d'identité par reconnaissance faciale · ArcFace vs FaceNet · TensorFlow 2.13</p>
    </div>
    """, unsafe_allow_html=True)
