...
from metrics import evaluate_model, plot_all_metrics
...
def main():
    ...
    if faces1 is None:
        print("\n⚠️  LFW non disponible pour l'évaluation.")
        print("   → Solution 1: Téléchargez manuellement depuis https://vis-www.cs.umass.edu/lfw/")
        print("   → Solution 2: Utilisez l'interface Streamlit pour tester manuellement")
        print("   → Commande: streamlit run app.py")
        print("   → Les modèles sont entraînés mais pas évalués automatiquement.")
        return
